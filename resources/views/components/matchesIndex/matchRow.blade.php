        ...
        <a href="/match" class="border-transparent flex flex-row w-full h-full items-center">
            ...
            <div class="items-col w-[50px] md:w-[60px] items-center hidden sm:flex">
                <div class="flex flex-col items-center mx-auto">
                    <img src='{{ "https://api.cybersportscore.com/mediamedia/logo/_30/t".$game->t1.".webp" }}'
            ...
            <div class="items-col w-[80px] hidden sm:flex items-center">
                <div class="flex flex-col items-center mx-auto">
                    <img src="{{ asset('media/event/_120/e'.$game->id) }}" title="Miso Soup" alt="Miso Soup icon" loading="lazy" class="w-[1.6rem] h-[1.6rem] inline">
                </div>
            </div>
