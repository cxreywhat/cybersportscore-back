@foreach($data as $item)
    ...
    <div class="flex border-b border-gray-700 hover:bg-gray-800 py-1">
        ...
        <div class="flex grow py-1 gap-2 relative">
            <div class="flex grow flex-1 content-center md:items-center gap-1 md:gap-3 flex-row">
                            <span class="px-2 w-14">
                                <img src="{{$item->getTeams()[1]->hasLogo ? "https://api.cybersportscore.com/media/logo/_30/t".$item->getTeams()[1]->id.".webp" : asset('media/icons/no-icon.svg')}}"
        ...
        <div class="flex items-center w-[140px] justify-end gap-3 pr-3">
            ...
            <span class="px-1">
                            <img src="{{ $item->getLogo() ? "https://api.cybersportscore.com/media/event/_120/e".$item->getLogo().".webp" : asset('media/icons/no-icon.svg')}}"
