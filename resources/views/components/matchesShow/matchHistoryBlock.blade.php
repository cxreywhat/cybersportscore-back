<div class="flex flex-row p-2 rounded-t-lg border-x border-t justify-between items-center border-gray-700">
    <h3 class="text-l font-bold text-[#d1d5db] pl-3 pr-1" data-translate="labels.last_matches">
        Последние матчи
    </h3>
</div>
<div id="historyBlock" class="hidden sm:hidden md:grid border border-gray-700 grid-cols-1 rounded-b-lg md:grid-cols-6 relative">
...
{{--                    <span class="px-4">--}}
{{--                        <img src="{{asset("/media/logo/_30/t".$history->matchTitle->team1->logo.".webp")}}" alt="undefined icon" class="w-[1.6rem] aspect-[3/2] object-contain" loading="lazy">--}}
{{--                    </span>--}}
{{--                </div>--}}
...
{{--                <span class="px-4">--}}
{{--                    <img src="{{asset('/media/logo/_30/t'.$history->matchTitle->team2->logo.'.webp')}}" alt="undefined icon" class="w-[1.6rem] aspect-[3/2] object-contain" loading="lazy">--}}
{{--                </span>--}}
{{--                <span class="text-gray-300 text-[12px] leading-4">--}}
...
{{--                        <span class="mx-4">--}}
{{--                            <img src="{{ $common->getLogo() ? asset('/media/event/_120/e'.$common->getLogo().'.webp') : asset('media/icons/no-icon.svg')}}"--}}
...
{{--            <span class="px-4">--}}
{{--                <img src="{{asset('/media/logo/_30/t'.$history->matchTitle->team1->logo.'.webp')}}"--}}
...
{{--        <div class="flex items-center bg-gray-700 bg-opacity-40 border-b border-gray-700 py-2">--}}
{{--            <span class="px-4">--}}
{{--                <img src="{{asset('/media/logo/_30/t'.$history->matchTitle->team2->logo.'.webp')}}"--}}
