export function statisticsPlayersTeam(playersTeam1, gameId, isLive, numTeam) {
    ...
    playersTeam.forEach(player => {
        ...
        const itemsDiv = playerRow.querySelector('#items-' + numTeam);
    ...
    return `
        <td class="py-1 px-2">
            <div class="flex flex-row gap-2 items-center">
                ...
                <div class="flex-col">
                    <div class="flex text-xs leading-none text-gray-300">${player.nick}</div>
        ...
        <td class="py-2 px-1"><div id="items-${numTeam}" class="flex gap-2 w-[240px]"></div></td>
