...
function picksTeam(picks, gameId, numTeam) {
    ...
    picks.forEach(pick => {
        ...
        picksRow.innerHTML =`<img class="transform scale-110" title="${pick.hero_title}" alt="${pick.hero_title}" src="/media/game/hero/${gameId}/_59/${pick.hero_id}.png">`;
...
function bansTeam(bans, gameId, numTeam) {
    ...
    bans.forEach(ban => {
        ...
        bansRow.innerHTML = `<img class="transform scale-110 grayscale hover:grayscale-0" title="${ban.hero_title}" alt="${ban.hero_title}" src="/media/game/hero/${gameId}/_59/${ban.hero_id}.png" >`;
