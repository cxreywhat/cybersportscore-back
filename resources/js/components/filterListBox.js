...
function selectItem(listItems, itemSelect, selectedItem, side) {
    ...
    listItems.querySelectorAll('li').forEach((item) => {
        ...
        item.addEventListener('click', (e) => {
            ...
            if (!existingCheckmark) {
                item.innerHTML += `<span id='checkmark' class="absolute inset-y-0 right-0 flex items-center pr-4" style="text-color: rgb(255, 255, 255)"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" class="h-5 w-5"><path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clip-rule="evenodd"></path></svg></span>`;
            }
